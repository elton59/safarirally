    ...
    <section id="main-content">
      <section class="wrapper">
                ...
                <?php
                 $sunguch=$login_session;
                  ...
                  while($row=$result->fetch_assoc())
                  {
                    ...
                    <td> <a href='cpayment.php?apid=$row[id]' class='btn btn-success' >Approve<a>
                   <a href='cpayment.php? rjid=$row[id]' class='btn btn-danger' >Reject<a></td>
                   </tbody>
                    "
                  ;}
            ?>
        ...
        if (isset($_GET['apid'])) {
          ...
          $result=$mysqli->query("update paymentdetails set status='$a' where id='$id'")or die($mysqli->error);
          
            echo"<script>window.location.replace('cpayment.php')</script>";
          }
          if (isset($_GET['rjid'])) {
            $id=$_GET['rjid'];
            $b='rejected';
           
            $result=$mysqli->query("update paymentdetails set status='$b' where id='$id'")or die($mysqli->error);
