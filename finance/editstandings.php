          ...
          <div class="col-12">
            <section class="panel">
              ...
              <table class="table-responsive table table-bordered">
                ...
                <?php
                  $result=$mysqli->query("select * from standings")or die($mysqli->error);
                  while($row=$result->fetch_assoc())
                  {
                    ...
                    <td>".$row['reward']."</td>
                    <td>".$row['points']."</td>
                   <td> <a href='editstandings.php?apstid=$row[id]'  class='btn btn-primary'>Edit<a>
...
?>
 ...
 <input  name="id"type="text" class="form-control round-input"  value='<?php echo $id; ?>'>
               <div class="form-group">
                 ...
                 <div class="col-sm-10">
                   <input  name="stid"type="text" class="form-control round-input" placeholder="input Standing ID"  value='<?php echo $stid; ?>'>
                 </div>
               </div>
               <div class="form-group">
                 <label class="col-sm-2 control-label">Standing Date</label>
                 <div class="col-sm-10">
                   <input name="stdate" type="date" class="form-control round-input" placeholder="input  Date"  value='<?php echo $stdate; ?>'>
                 </div>
               </div>
               <div class="form-group">
                 <label class="col-sm-2 control-label">Tag Number</label>
                 <div class="col-sm-10">
                   <input name="sttno" type="number" class="form-control round-input" placeholder="input  Tag Number "  value='<?php echo $sttno; ?>'>
                 </div>
               </div>
               <div class="form-group">
                 <label class="col-sm-2 control-label">DriverID</label>
                 <div class="col-sm-10">
                   <input  name="stdid" type="text" class="form-control round-input" placeholder="input DriverID"  value='<?php echo $stid; ?>'>
                 </div>
              </div>
              <div class="form-group">
                 <label class="col-sm-2 control-label">DriverName</label>
                 <div class="col-sm-10">
                   <input  name="stdname" type="text" class="form-control round-input" placeholder="input  DriverName"  value='<?php echo $stcodname; ?>'>
                 </div>
                 </div>
              <div class="form-group">
                 <label class="col-sm-2 control-label">CoDriverName</label>
                 <div class="col-sm-10">
                   <input  name="stcodname" type="text" class="form-control round-input" placeholder="input  CoDriverName"  value='<?php echo $stcodname; ?>'>
                 </div>
                 </div>
                 <div class="form-group">
                 <label class="col-sm-2 control-label">CompletionTime </label>
                 <div class="col-sm-10">
                   <input  name="stcot" type="text" class="form-control round-input" placeholder="input  CompletionTime"  value='<?php echo $stcot; ?>'>
                 </div>
               </div>
               <div class="form-group">
                 <label class="col-sm-2 control-label">EventID </label>
                 <div class="col-sm-10">
                   <input  name="steid" type="text" class="form-control round-input" placeholder="input EventID"  value='<?php echo $steid; ?>'>
                 </div>
               </div>
               <div class="form-group">
