...
if (isset($_GET['bpid'])) {
  $id = $_GET['bpid'];
  $sql = $mysqli->query("update  paymentdetails set status='approved' where id='$id'") or die($mysqli->error);
...
if(isset($_POST['adcod']))
{
  ...
  $codins=$_POST['codins'];
           ...
           $sql=$mysqli->query("INSERT INTO codriverdetails(codriverid,fullname,teamid,nationality,insurancenumber,gender,email)VALUES('$codid','$codname','$codtid','$codnat','$codins','$codgen','$codemail')") or die($mysqli->error);
           if($sql){
...
if(isset($_POST['uadcod']))
{
  ...
  $codins=$_POST['codins'];
           ...
           $sql=$mysqli->query("UPDATE codriverdetails SET codriverid='$codid',fullname='$codname',teamid='$codtid',nationality='$codnat',insurancenumber='$codins',gender='$codgen',email='$codemail' where id=$id") or die($mysqli->error);
           if($sql){
...
if(isset($_POST['uadtm']))
{
  ...
  $tmpid=$_POST['tmpid'];
           ...
           $sql=$mysqli->query("UPDATE team SET teamid='$tmid',drivername='$tmdname',tagnumber='$tmtno',codrivername='$tmcodname',racecarregistrationnumber='$tmrcno',paymentid='$tmpid' where id='$id'") or die($mysqli->error);
           if($sql){
...
{
$id=$_GET['rjbut'];
$sql=$mysqli->query("UPDATE  paymentdetails set status='rejected' where id='$id'")or die($mysqli->error);
