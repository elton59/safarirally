          ...
          Awaiting Aprroval
              ...
              <div class="table-responsive">
               <table class="table-responsive table table-bordered" id="events">
                ...
                <tbody>
                <?php
                  $result=$mysqli->query("select * from eventdetail where status='paid_awaiting_approval'")or die($mysqli->error);
                  while($row=$result->fetch_assoc())
                  {
                    ...
                    <td>".$row['status']."</td>
                    <td> <a href='process.php?bpid2=$row[id]' class='btn btn-success' >Approve</a>
                   </td>
                   </tbody>
                    "
                  ;}
