    ...
    <section id="main-content">
      <section class="wrapper">
        ...
        <div class="row">
         ...
         <div class="col-sm-10">
				   <select name="codnat" class="form-control round-input" >
           <option  class="form-control " value="none">(Choose county)  </option>
				...
				<div class="col-sm-10">
				  ...
				  <select name="codgen" class="form-control round-input" >
          <option  class="form-control " value="None">Select Gender</option>
