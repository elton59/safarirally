...
function fetch_data()
{
  ...
  include('conn.php');
   ...
   $result=$mysqli->query("select * from eventdetail where  driver_email='$em' and status='booked' and payment_status!='nopay'")or die($mysqli->error);
...
<h3 align="center"><u>Booked Events </u></h3>
...
$pdf->output('Booked Events.pdf','I');
