              ...
              <section class="panel">
                ...
                <table class="table-responsive table table-bordered" id="standing"> 
                  ...
                  ;
                    ...
                    FROM standings  JOIN team ON team.teamtagnumber=standings.tagnumber where team.driver_email='$login_session' order by standings.eventid")or die($mysqli->error);
