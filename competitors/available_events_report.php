...
function fetch_data()
{
  ...
  include('conn.php');
   ...
   $result2=$mysqli->query("select * from eventdetail where  driver_email='$em'  and payment_status!='nopay'")or die($mysqli->error);
...
<h3 align="center"><u>Available Events</u></h3>
...
$pdf->output('available Events.pdf','I');
