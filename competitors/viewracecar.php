  ...
  <section id="container" class="">
    ...
    <section id="main-content">
      <section class="wrapper">
        <div class="row">
          <div class="col-lg-12">
            <h3 class="page-header"><i class="fa fa-table"></i> View Race car</h3>
            <ol class="breadcrumb">
            ...
            <section class="panel">
              ...
              <div class="table-responsive">
               <table class="table-responsive table table-bordered" id="awards">
                ...
                <?php
                  $result=$mysqli->query("select * from racecar where driver_email='$login_session'")or die($mysqli->error);
