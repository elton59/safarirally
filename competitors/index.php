...
<head>
	<meta charset="UTF-8">
	<title>Safari Rally Competitors Log in</title>
...
<body>
	...
	<div class="form-box">
        ...
        <input  name="password" class="form control" placeholder="Your Password" type="password"  id="myInput"> 
		<div class="form-group">
				
				<div class="col-sm-10">
			  <button type="button"  class="form-control" style="color:red" onclick="myFunction()"><p style="color:black"> Show Password 
			  </div>
			  </div>
