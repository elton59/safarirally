  ...
  <section id="container" class="">
    ...
    <section id="main-content">
      <section class="wrapper">
        <div class="row">
          <div class="col-lg-12">
            <h3 class="page-header"><i class="fa fa-file-text-o"></i> Create Message</h3>
            <ol class="breadcrumb">
                        </ol>
          </div>
        </div>
            ...
            Create message
              ...
              <form class="form-horizontal " method="POST" action="process.php">
               ...
               <div class="form-group">
                 ...
                 <div class="col-sm-10">
                   <input  name="fdemail"type="text" class="form-control round-input" placeholder="input email" value="<?php echo $sunguch?>"  readonly>
                 </div>
               </div>
               <div class="form-group">
