              ...
              <div class="panel-body">
                <form class="form-horizontal " method="POST" action="process.php">
                 ...
                 <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      <input  name="evdue" type="text" class="form-control round-input" placeholder="input event Duration">
                    </div>
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      <input  name="evdr" type="text" class="form-control round-input" placeholder="input driver name">
                    </div>
                  </div>
                  <div class="form-group">
                    <label class="col-sm-2 control-label">codrivername </label>
                    <div class="col-sm-10">
                      <input  name="evcod" type="text" class="form-control round-input" placeholder="input codrivername">
                    </div>
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      <input  name="evttno" type="text" class="form-control round-input" placeholder="input event Team Tag Number">
                    </div>
                  </div>
                  <div class="form-group">
                  ...
                  <center>
                  <input class="btn btn-primary" href="" title="Bootstrap 3 themes generator" type="submit" name="schev" value="Schedule"/>
