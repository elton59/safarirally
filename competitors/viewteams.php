        ...
        <div class="row">
          <div class="col-12">
            <section class="panel">
              ...
              <div class="table-responsive">
               <table class="table-responsive table table-bordered" id="teams">
                ...
                <?php
                  $result=$mysqli->query("select * from team where driver_email='$login_session'")or die($mysqli->error);
            ...
            ?>
              ...
              <a href="myteam_report.php?apapsid=<?php echo $login_session;?>"  button class="btn btn-success 
                                ">Download</a>
                  </div>
            </section>
          </div>
