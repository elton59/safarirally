	...
	<div class="form-box">
		...
		<form class="form-horizontal " method="POST" action="process.php"  oninput='up2.setCustomValidity(conpass.value != drpass.value ? "Passwords do not match." : "")'>
			   ...
			   <div class="form-group">
				 ...
				 <div class="col-sm-10">
				   <input  name="drid"type="text" class="form-control round-input" placeholder="input Driver National ID No" required minlength="5" maxlength="12">
				 </div>
			   </div>
			   <div class="form-group">
				
				 <div class="col-sm-10">
				   <input name="drname" type="text" class="form-control round-input" placeholder="input Driver Full Name" minlength="5"  maxlength="30" required>
				 </div>
			   </div>
			   <div class="form-group">
			
				 <div class="col-sm-10">
				   <input name="drlno" type="text" class="form-control round-input" placeholder="input Driver Lincense Number" required  minlength="5" maxlength="12">
				 </div>
			   </div>
			   <div class="form-group">
				 <div class="col-sm-10">
				 <p>Select Nationality</p>
				   <select name="drnat"  class="form-control">
			   ...
			   <div class="form-group">
				...
				<div class="col-sm-10">
				<p>Select Gender</p>
				  <select name="drgen"  class="form-control">
			   ...
			   <div class="form-group">
				 ...
				 <div class="col-sm-10">
				   <input name="drspon" type="text" class="form-control round-input" placeholder="input Sponsor " required  maxlength="11">
				 </div>
			   </div>
			   <div class="form-group">
				
				 <div class="col-sm-10">
				   <input name="dremail"  pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,4}$" type="email" class="form-control round-input" placeholder="input Driver Email" required  maxlength="32">
				 </div>
			   </div>
			   <div class="form-group">
