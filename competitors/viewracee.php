  ...
  <section id="container" class="">
    ...
    <section id="main-content">
      <section class="wrapper">
        <div class="row">
          <div class="col-lg-12">
            <h3 class="page-header"><i class="fa fa-table"></i> View Recee car</h3>
            <ol class="breadcrumb">
            ...
            <section class="panel">
              ...
              <div class="table-responsive">
               <table class="table-responsive table table-bordered" id="awards">
                ...
                <?php
                  $result=$mysqli->query("select * from receecar where driver_email='$login_session'")or die($mysqli->error);
                  while($row=$result->fetch_assoc())
                  {
                    ...
                    <td>".$row['make']."</td>
                    <td>".$row['model']."</td>
                    <td>".$row['Year_of_manufucture']."</td>
                    <td>".$row['country_of_registration']."</td>
                    <td>".$row['number_of_doors']."</td>
                    <td>".$row['registration_number']."</td>
                    <td>".$row['cc']."</td>
                    <td>".$row['chasis']."</td>
                    <td>".$row['engine_number']."</td>
                    <td>".$row['predominant_color']."</td>
