  ...
  <section id="container" class="">
    ...
    <section id="main-content">
      <section class="wrapper">
        <div class="row">
          <div class="col-lg-12">
            <h3 class="page-header"><i class="fa fa-table"></i> View CoDrivers</h3>
            <ol class="breadcrumb">
          ...
          <div class="col-12">
            <section class="panel">
              ...
              <div class="table-responsive">
               <table class="table-responsive table table-bordered" id="codrivers">
                <thead>
                  <tr>
                    <th>Full Name</th>
                    <th>NationalID</th>
                ...
                <?php
                  $result=$mysqli->query("select * from codriverdetails where driver_email='$login_session'")or die($mysqli->error);
...

{
 ...
 tab = document.getElementById('codrivers'); // id of table
