  ...
  <section id="container" class="">
    ...
    <section id="main-content">
      <section class="wrapper">
        <div class="row">
          <div class="col-lg-12">
            <h3 class="page-header"><i class="fa fa-table"></i> Edit Finance</h3>
            <ol class="breadcrumb">
              ...
              <table class="table-responsive table table-bordered">
                ...
                <?php
                  ...
                  while($row=$result->fetch_assoc())
                  {
                    ...
                    <td>".$row['email']."</td>
                    <td>".$row['password']."</td>
                   <td> <a href='editfinance.php?apfinid=$row[id]' class='btn btn-primary'>Edit<a>
                   <a href='process.php? delfinid=$row[id]' class='btn btn-danger' > Delete<a></td>
                   </tbody>
                    "
                  ;}
            ?>
              ...
              <?php
    if (isset($_GET['apfinid']))
{
  $id=$_GET['apfinid'];
  $result=$mysqli->query("select * from finance where id=$id")or die($mysqli->error);
    $row=$result->fetch_array();
    $finem=$row['email'];
    $finpass=$row['password'];
...
?>
 ...
 <input  name="id"type="hidden" class="form-control round-input"  value='<?php echo $id; ?>'>
               <div class="form-group">
                 ...
                 <div class="col-sm-10">
                   <input  name="finem"type="text" class="form-control round-input" placeholder="input Email" value='<?php echo $finem; ?>'>
                 </div>
               </div>
               <div class="form-group">
                 <label class="col-sm-2 control-label">Password</label>
                 <div class="col-sm-10">
                   <input name="finpass" type="text" class="form-control round-input" placeholder="input  password" value='<?php echo $finpass; ?>'>
                 </div>
               </div>
                         <center>
               <input class="btn btn-primary" href="" title="Bootstrap 3 themes generator" type="submit" name="eafi" value="Update"/>
