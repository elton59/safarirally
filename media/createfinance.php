      ...
      <section class="wrapper">
        <div class="row">
          <div class="col-lg-12">
            ...
            <ol class="breadcrumb">
              <li><i class="fa fa-home"></i><a href="viewfinance.php">viewuser</a></li>
            </ol>
            <ol class="breadcrumb">
              <li><i class="fa fa-home"></i><a href="editfinance.php">edituser</a></li>
            </ol>
          </div>
        </div>
        <div class="row">
              ...
              <div class="panel-body">
                <form class="form-horizontal " method="POST" action="process.php">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      <input  name="finem"type="text" class="form-control round-input" placeholder="input email">
                    </div>
                  </div>
                  <div class="form-group">
                    <label class="col-sm-2 control-label">Password</label>
                    <div class="col-sm-10">
                      <input name="finpass" type="text" class="form-control round-input" placeholder="input Password">
                    </div>
                  </div>
