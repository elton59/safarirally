...
<head>
  ...
  <title> Create Createcodrvers</title>
  ...
  <section id="container" class="">
    ...
    <section id="main-content">
      <section class="wrapper">
        <div class="row">
          <div class="col-lg-12">
            <h3 class="page-header"><i class="fa fa-file-text-o"></i> AddcoDriver</h3>
            <ol class="breadcrumb">
              <li><i class="fa fa-home"></i><a href="viewcodrivers.php">viewcoDrivers</a></li>
            </ol>
            <ol class="breadcrumb">
              <li><i class="fa fa-home"></i><a href="editcodrivers.php">editcoDrivers</a></li>
            </ol>
          </div>
        </div>
        <div class="row">
              ...
              <div class="panel-body">
                <form class="form-horizontal " method="POST" action="process.php">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      <input  name="codid"type="text" class="form-control round-input" placeholder="input CoDriver ID">
                    </div>
                  </div>
                  <div class="form-group">
                    <label class="col-sm-2 control-label">Full Name</label>
                    <div class="col-sm-10">
                      <input name="codname" type="text" class="form-control round-input" placeholder="input Driver Full Name">
                    </div>
                  </div>
                  <div class="form-group">
                    <label class="col-sm-2 control-label">Team ID</label>
                    <div class="col-sm-10">
                      <input name="codtid" type="text" class="form-control round-input" placeholder="input Team ID" value="yet to be assigned" disabled>
                    </div>
                  </div>
                  <div class="form-group">
                    <label class="col-sm-2 control-label">Nationality</label>
                    <div class="col-sm-10">
                      <input name="codnat" type="text" class="form-control round-input" placeholder="input Driver Nationality">
                    </div>
                  </div>
                  <div class="form-group">
                    <label class="col-sm-2 control-label">Insurance Number</label>
                    <div class="col-sm-10">
                      <input name="codins" type="text" class="form-control round-input" placeholder="input Insurance Number">
                    </div>
                  </div>
                  <div class="form-group">
                    <label class="col-sm-2 control-label">Gender</label>
                    <div class="col-sm-10">
                      <input name="codgen" type="text" class="form-control round-input" placeholder="input Gender">
                    </div>
                  </div>
                  <div class="form-group">
                    <label class="col-sm-2 control-label">Email</label>
                    <div class="col-sm-10">
                      <input name="codemail" type="text" class="form-control round-input" placeholder="input  Email">
                    </div>
                  </div>
