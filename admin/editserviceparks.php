...
?>
 ...
 <form class="form-horizontal " method="POST" action="process.php">
               ...
               <div class="form-group">
                 ...
                 <div class="col-sm-10">
                 <input  name="srid"type="text" class="form-control round-input"  value='<?php echo $srid; ?>'>
                 </div>
               </div>
               <div class="form-group">
                   <label class="col-sm-2 control-label">Provider</label>
                 <div class="col-sm-10">
                   <input name="srp" type="year" class="form-control round-input" placeholder="input  Provider"  value='<?php echo $srp ?>' disabled>
                 </div>
               </div>
               <div class="form-group">
                 <label class="col-sm-2 control-label">RaceCarRegistrationNumber</label>
                 <div class="col-sm-10">
                   <input name="srcr" type="text" class="form-control round-input" placeholder="input  RaceCarRegistrationNumber"  value='<?php echo $srcr; ?>' disabled>
                 </div>
               </div>
               <div class="form-group">
                 <label class="col-sm-2 control-label">TeamTagNUmber</label>
                 <div class="col-sm-10">
                   <input  name="srttno" type="text" class="form-control round-input" placeholder="input TeamTagNUmber"  value='<?php echo $srttno; ?>' disabled>
                 </div>
              </div>
