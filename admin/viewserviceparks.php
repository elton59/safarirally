        ...
        <div class="row">
          <div class="col-12">
            <section class="panel">
              ...
              <table class="table-responsive table table-bordered" id="service">
                <thead>
                  <tr>
                    <th>ServiceID</th>
                    <th>Provider</th>
                ...
                <?php
                  ...
                  while($row=$result->fetch_assoc())
                  {
                   ...
                   <td> <a href='editawards.php?apawid=$row[id]' <a>
                   <a href='process.php? delawid=$row[id]'  > <a></td>
                   </tbody>
                    "
                  ;}
            ?>
...

{
    ...
    tab = document.getElementById('service'); // id of table
