  ...
  <section id="container" class="">
    ...
    <section id="main-content">
      <section class="wrapper">
        <div class="row">
          <div class="col-lg-12">
            <h3 class="page-header"><i class="fa fa-table"></i> View Finance</h3>
            <ol class="breadcrumb">
            ...
            <section class="panel">
              ...
              <div class="table-responsive">
               <table class="table-responsive table table-bordered">
                ...
                <?php
                  $result=$mysqli->query("select * from finance where status='approved'")or die($mysqli->error);
                  while($row=$result->fetch_assoc())
                  {
                    ...
                    <td>".$row['password']."</td>
                    <td>".$row['status']."</td>
                    <td> <a href='process.php?afinbuttid=$row[id]' class='btn btn-primary' > Approve<a>
                   <a href='process.php? rjfinbuttid=$row[id]' class='btn btn-danger' > Reject<a></td>
                   </tbody>
                    "
                  ;}
            ?>
            ...
            <section class="panel">
              ...
              <div class="table-responsive">
               <table class="table-responsive table table-bordered">
                ...
                <?php
                  $result=$mysqli->query("select * from finance where status='pending'")or die($mysqli->error);
                  while($row=$result->fetch_assoc())
                  {
                    echo
            ...
            <section class="panel">
              ...
              <div class="table-responsive">
               <table class="table-responsive table table-bordered">
                ...
                <?php
                  $result=$mysqli->query("select * from finance where status='rejected'")or die($mysqli->error);
                  while($row=$result->fetch_assoc())
                  {
                    echo
