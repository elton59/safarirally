  ...
  <section id="container" class="">
    ...
    <section id="main-content">
      <section class="wrapper">
        <div class="row">
          <div class="col-lg-12">
            <h3 class="page-header"><i class="fa fa-file-text-o"></i> Add Media</h3>
            <ol class="breadcrumb">
              <li><i class="fa fa-home"></i><a href="viewmedia.php">viewMedia</a></li>
            </ol>
            <ol class="breadcrumb">
              <li><i class="fa fa-home"></i><a href="editmedia.php">editMedia</a></li>
            </ol>
          </div>
        </div>
        <div class="row">
              ...
              <div class="panel-body">
                <form class="form-horizontal " method="POST" action="process.php">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      <input  name="mid"type="text" class="form-control round-input" placeholder="input Media ID">
                    </div>
                  </div>
                  <div class="form-group">
                    <label class="col-sm-2 control-label">FullName</label>
                    <div class="col-sm-10">
                      <input name="mname" type="text" class="form-control round-input" placeholder="input Media Name">
                    </div>
                  </div>
                  <div class="form-group">
                    <label class="col-sm-2 control-label">Category</label>
                    <div class="col-sm-10">
                      <input name="mcat" type="text" class="form-control round-input" placeholder="input Category">
                    </div>
                  </div>
                  <div class="form-group">
                    <label class="col-sm-2 control-label">Email</label>
                    <div class="col-sm-10">
                      <input name="memail" type="text" class="form-control round-input" placeholder="input  Email">
                    </div>
                  </div>
                  <div class="form-group">
                    <label class="col-sm-2 control-label">Password</label>
                    <div class="col-sm-10">
                      <input name="mpass" type="text" class="form-control round-input" placeholder="input Password">
                    </div>
                  </div>
                  <div class="form-group">
                    <label class="col-sm-2 control-label">Contact</label>
                    <div class="col-sm-10">
                      <input name="mcont" type="text" class="form-control round-input" placeholder="input Contact">
                    </div>
                  </div>
                  <div class="form-group">
                    <label class="col-sm-2 control-label">Payment ID</label>
                    <div class="col-sm-10">
                      <input name="mpay" type="text" class="form-control round-input" placeholder="input Payment ID">
                    </div>
                  </div> 
                
                  <center>
                  <input class="btn btn-primary" href="" title="Bootstrap 3 themes generator" type="submit" name="adm" value="Create"/>
