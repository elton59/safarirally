 ...
 <form class="form-horizontal " method="POST" action="process.php">
              <input  name="id"type="hidden" class="form-control round-input"  value='<?php echo $id; ?>'>
               <div class="form-group">
                 ...
                 <div class="col-sm-10">
                   <input  name="tmid"type="text" class="form-control round-input" placeholder="input Team ID" value='<?php echo $tmid; ?>' readonly>
                 </div>
               </div>
               <div class="form-group">
                 <label class="col-sm-2 control-label">Tag Number</label>
                 <div class="col-sm-10">
                   <input name="tmtno" type="text" class="form-control round-input" placeholder="input Tag Number" value='<?php echo $tmtno; ?>'  >
                 </div>
               </div>
               <div class="form-group">
                 <label class="col-sm-2 control-label">Driver Name</label>
                 <div class="col-sm-10">
                   <input name="tmdname" type="text" class="form-control round-input" placeholder="input Driver Name" value='<?php echo $tmdname; ?>' eeadonly>
                 </div>
               </div>
               <div class="form-group">
                 <label class="col-sm-2 control-label">CoDriverName</label>
                 <div class="col-sm-10">
                   <input name="tmcodname" type="text" class="form-control round-input" placeholder="input Driver CodriverName" value='<?php echo $tmcodname; ?>' readonly>
                 </div>
               </div>
               <div class="form-group">
                 <label class="col-sm-2 control-label">RaceCarRegistrationNumber</label>
                 <div class="col-sm-10">
                   <input name="tmrcno" type="text" class="form-control round-input" placeholder="RaceCarRegistrationNumber" value='<?php echo $tmrcno; ?>'readonly>
                 </div>
               </div>
               <center>
