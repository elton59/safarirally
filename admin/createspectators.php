  ...
  <section id="container" class="">
    ...
    <section id="main-content">
      <section class="wrapper">
        <div class="row">
          <div class="col-lg-12">
            <h3 class="page-header"><i class="fa fa-file-text-o"></i> AddSpectators</h3>
            <ol class="breadcrumb">
              <li><i class="fa fa-home"></i><a href="viewspectators.php">viewSpectators</a></li>
            </ol>
            <ol class="breadcrumb">
              <li><i class="fa fa-home"></i><a href="editspectators.php">editSpectators</a></li>
            </ol>
          </div>
        </div>
        <div class="row">
              ...
              <div class="panel-body">
                <form class="form-horizontal " method="POST" action="process.php">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      <input  name="specname"type="text" class="form-control round-input" placeholder="input Name">
                    </div>
                  </div>
                  <div class="form-group">
                    <label class="col-sm-2 control-label">Nationality</label>
                    <div class="col-sm-10">
                      <input name="specnat" type="text" class="form-control round-input" placeholder="input Nationality">
                    </div>
                  </div>
                  <div class="form-group">
                    <label class="col-sm-2 control-label">Gender</label>
                    <div class="col-sm-10">
                      <input name="specgen" type="text" class="form-control round-input" placeholder="input Gender">
                    </div>
                  </div>
                  <div class="form-group">
                    <label class="col-sm-2 control-label">Email</label>
                    <div class="col-sm-10">
                      <input name="specemail" type="text" class="form-control round-input" placeholder="input Email">
                    </div>
                  </div>
                  <div class="form-group">
                    <label class="col-sm-2 control-label">Passwords</label>
                    <div class="col-sm-10">
                      <input name="specpass" type="text" class="form-control round-input" placeholder="input password">
                    </div>
                  </div>
                  <center>
                  <input class="btn btn-primary" href="" title="Bootstrap 3 themes generator" type="submit" name="adspec" value="Create"/>
