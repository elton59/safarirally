  ...
  <section id="container" class="">
    ...
    <section id="main-content">
      <section class="wrapper">
        <div class="row">
          <div class="col-lg-12">
            <h3 class="page-header"><i class="fa fa-file-text-o"></i> AddDriver</h3>
            <ol class="breadcrumb">
              <li><i class="fa fa-home"></i><a href="viewdrivers.php">viewDrivers</a></li>
            </ol>
            <ol class="breadcrumb">
              <li><i class="fa fa-home"></i><a href="editdrivers.php">editDrivers</a></li>
            </ol>
          </div>
        </div>
        <div class="row">
              ...
              <div class="panel-body">
                <form class="form-horizontal " method="POST" action="process.php">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      <input  name="drid"type="text" class="form-control round-input" placeholder="input Driver ID">
                    </div>
                  </div>
                  <div class="form-group">
                    <label class="col-sm-2 control-label">Full Name</label>
                    <div class="col-sm-10">
                      <input name="drname" type="text" class="form-control round-input" placeholder="input Driver Full Name">
                    </div>
                  </div>
                  <div class="form-group">
                    <label class="col-sm-2 control-label">Lincence Number</label>
                    <div class="col-sm-10">
                      <input name="drlno" type="text" class="form-control round-input" placeholder="input Driver Lincense Number">
                    </div>
                  </div>
                  <div class="form-group">
                    <label class="col-sm-2 control-label">Nationality</label>
                    <div class="col-sm-10">
                      <input name="drnat" type="text" class="form-control round-input" placeholder="input Driver Nationality">
                    </div>
                  </div>
                  <div class="form-group">
                    <label class="col-sm-2 control-label">CoDriverID</label>
                    <div class="col-sm-10">
                      <input name="drcodid" type="text" class="form-control round-input" placeholder="input Driver COdriverName">
                    </div>
                  </div>
                  <div class="form-group">
                    <label class="col-sm-2 control-label">Sponsor ID</label>
                    <div class="col-sm-10">
                      <input name="drspon" type="text" class="form-control round-input" placeholder="input Driver Sponsor ID">
                    </div>
                  </div>
                  <div class="form-group">
                    <label class="col-sm-2 control-label">Email</label>
                    <div class="col-sm-10">
                      <input name="dremail" type="text" class="form-control round-input" placeholder="input Driver Email">
                    </div>
                  </div>
                  <div class="form-group">
                    <label class="col-sm-2 control-label">Password</label>
                    <div class="col-sm-10">
                      <input name="drpass" type="password" class="form-control round-input" placeholder="input password">
                    </div>
                  </div>
                
                
                  <center>
                  <input class="btn btn-primary" href="" title="Bootstrap 3 themes generator" type="submit" name="adr" value="Create"/>
