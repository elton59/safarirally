  ...
  <section id="container" class="">
    ...
    <section id="main-content">
      <section class="wrapper">
        <div class="row">
          <div class="col-lg-12">
            <h3 class="page-header"><i class="fa fa-table"></i> Edit Media</h3>
            <ol class="breadcrumb">
              ...
              <table class="table-responsive table table-bordered">
                ...
                <?php
                  ...
                  while($row=$result->fetch_assoc())
                  {
                    ...
                    <td>".$row['contact']."</td>
                    <td>".$row['paymentid']."</td>
                    <td> <a href='editmedia.php?apmid=$row[id]' class='btn btn-primary' >Edit<a>
                   <a href='process.php? delmid=$row[id]' class='btn btn-danger' >Delete<a></td>
                   </tbody>
                    "
                  ;}
            ?>
...
{
  $id=$_GET['apmid'];
  $result=$mysqli->query("select * from mediadetails where id=$id")or die($mysqli->error);
...
?>
 ...
 <input  name="id"type="hidden" class="form-control round-input"  value='<?php echo $id; ?>'>
               <div class="form-group">
                 ...
                 <div class="col-sm-10">
                   <input  name="mid"type="text" class="form-control round-input" placeholder="input Media ID" value='<?php echo $mid; ?>'>
                 </div>
               </div>
               <div class="form-group">
                 <label class="col-sm-2 control-label">FullName</label>
                 <div class="col-sm-10">
                   <input name="mname" type="text" class="form-control round-input" placeholder="input Media Name" value='<?php echo $mname; ?>'>
                 </div>
               </div>
               <div class="form-group">
                 <label class="col-sm-2 control-label">Category</label>
                 <div class="col-sm-10">
                   <input name="mcat" type="text" class="form-control round-input" placeholder="input Category" value='<?php echo $mcat; ?>'>
                 </div>
               </div>
               <div class="form-group">
                 <label class="col-sm-2 control-label">Email</label>
                 <div class="col-sm-10">
                   <input name="memail" type="text" class="form-control round-input" placeholder="input  Email" value='<?php echo $memail; ?>'>
                 </div>
               </div>
               <div class="form-group">
                 <label class="col-sm-2 control-label">Password</label>
                 <div class="col-sm-10">
                   <input name="mpass" type="text" class="form-control round-input" placeholder="input Password" value='<?php echo $mpass; ?>'>
                 </div>
               </div>
               <div class="form-group">
                 <label class="col-sm-2 control-label">Contact</label>
                 <div class="col-sm-10">
                   <input name="mcont" type="text" class="form-control round-input" placeholder="input Contact" value='<?php echo $mcont; ?>'>
                 </div>
               </div>
               <div class="form-group">
                 <label class="col-sm-2 control-label">Payment ID</label>
                 <div class="col-sm-10">
                   <input name="mpay" type="text" class="form-control round-input" placeholder="input Payment ID" value='<?php echo $mpay; ?>'>
                 </div>
               </div> 
             
               <center>
               <input class="btn btn-primary" href="" title="Bootstrap 3 themes generator" type="submit" name="uadm" value="Update"/>
