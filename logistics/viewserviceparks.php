...
<head>
  ...
  <title>view Service Parks</title>
      ...
      <div class="row">
          <div class="col-12">
              ...
              <table class="table-responsive table table-bordered" id="serviceparks">
                ...
                <?php
                  ...
                  while($row=$result->fetch_assoc())
                  {
                    ...
                    <td>".$row['status']."</td>
                    <td> <a href='viewserviceparks.php?adrbuttid=$row[id]' class='btn btn-primary' >Approve<a>
            ...
            ?>
             ...
             $id=$_GET['adrbuttid'];
             $sql=$mysqli->query("update service set status='approved'  where id='$id'")or die($mysqli->error);
...

{
 ...
 tab = document.getElementById('serviceparks'); // id of table
