            ...
            <section class="panel">
              ...
              <div class="table-responsive">
               <table class="table-responsive table table-bordered" id="fixtures">
                ...
                <?php
                  $result=$mysqli->query("select * from schedule order by schedueid")or die($mysqli->error);
                  while($row=$result->fetch_assoc())
                  {
                    ...
                    <td> <a href='createstandings.php?ffpid=$row[id]' class='btn btn-success' >Create Standing</a>
                    </td>
