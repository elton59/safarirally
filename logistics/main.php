...
<head>
  ...
  <title>Safari rally Logistics</title>
        ...
        <div class="row">
          ...
          <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
            ...
            <i class="fa fa-cubes"></i>
              <div class="count">
                <?php
              $result=$mysqli->query("select *  from eventdetail where status='booked'") or die(mysqli_error($mysqli));
              ...
              <div class="title">Pending Events</div>
            </div>
            <!--/.info-box-->
          </div></a>
          <!--/.col-->
