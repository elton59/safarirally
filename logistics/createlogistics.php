...
<head>
 ...
 <link href=".../logistics/css/bootstrap.min.css" rel="stylesheet">
  ...
  <!-- Custom styles -->
  <link rel="../logistics/tylesheet" href="css/fullcalendar.css">
  ...
  <section id="container" class="">
    ...
    <section id="main-content">
      <section class="wrapper">
        <div class="row">
          <div class="col-lg-12">
            <h3 class="page-header"><i class="fa fa-file-text-o"></i> AddUser</h3>
            <ol class="breadcrumb">
              <li><i class="fa fa-home"></i><a href="viewlogistics.php">viewuser</a></li>
            </ol>
            <ol class="breadcrumb">
              <li><i class="fa fa-home"></i><a href="editlogistics.php">edituser</a></li>
            </ol>
          </div>
        </div>
        <div class="row">
              ...
              <div class="panel-body">
                <form class="form-horizontal " method="POST" action="process.php">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      <input  name="logem"type="text" class="form-control round-input" placeholder="input email">
                    </div>
                  </div>
                  <div class="form-group">
                    <label class="col-sm-2 control-label">Password</label>
                    <div class="col-sm-10">
                      <input name="logpass" type="text" class="form-control round-input" placeholder="input Password">
                    </div>
                  </div>
                  ...
                  <center>
                  <input class="btn btn-primary" href="" title="Bootstrap 3 themes generator" type="submit" name="alog" value="Issue"/>
