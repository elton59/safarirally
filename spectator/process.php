...
if(isset($_POST['login']))
   {
	...
	$result=$mysqli->query("SELECT * FROM spectatordetails where email='$email' AND password='$password' and status='approved'") or die($mysqli->error);
	$row=$result->fetch_assoc();
	$count=mysqli_num_rows($result);
		  if($count==1)
	{
		$_SESSION['spectator']=$email;
