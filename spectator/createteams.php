              ...
              <div class="panel-body">
                <form class="form-horizontal " method="POST" action="process.php">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      <input  name="tmid"type="text" class="form-control round-input" placeholder="input Team ID">
                    </div>
                  </div>
                  <div class="form-group">
                    <label class="col-sm-2 control-label">Tag Number</label>
                    <div class="col-sm-10">
                      <input name="tmtno" type="text" class="form-control round-input" placeholder="input Tag Number" value="yet to be assigned" readonly>
                    </div>
                  </div>
                  <div class="form-group">
                    <label class="col-sm-2 control-label">Driver Name</label>
                    <div class="col-sm-10">
                      <input name="tmdname" type="text" class="form-control round-input" placeholder="input Drivername" >
                    </div>
                  </div>
                  <div class="form-group">
                    <label class="col-sm-2 control-label">CoDriverName</label>
                    <div class="col-sm-10">
                      <input name="tmcodname" type="text" class="form-control round-input" placeholder="input codrivername">
                    </div>
                  </div>
                  <div class="form-group">
