              ...
              <div class="panel-body">
                <form class="form-horizontal " method="POST" action="process.php">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      <input  name="schid"type="text" class="form-control round-input" placeholder="input schedule ID">
                    </div>
                  </div>
                  <div class="form-group">
                    <label class="col-sm-2 control-label">RaceDate</label>
                    <div class="col-sm-10">
                      <input name="schrdate" type="date" class="form-control round-input" placeholder="input Race Date">
                    </div>
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      <input  name="schttno" type="text" class="form-control round-input" placeholder="input Team Tag Number">
                    </div>
                 </div>
                 <div class="form-group">
