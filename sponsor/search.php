    ...
    <section id="main-content">
      ...
      <div class="row">
          <div class="col-lg-12">
            ...
            <ol class="breadcrumb">
              <li><i class="fa fa-home"></i><a href="index.php"></a></li>
            </ol>
          </div>
        </div>
            ...
            <section class="panel">
              ...
              <div class="table-responsive">
               <table class="table-responsive table table-bordered" id="events">
                ...
                <tbody>
                <?php
                  $result=$mysqli->query("select * from eventdetail where eventname LIKE '%".$search."%' and status='approved'")or die($mysqli->error);
