	...
	<div class="form-box">
		...
		<form class="form-horizontal " method="POST" action="process.php">
			   ...
			   <div class="form-group">
				 ...
				 <div class="col-sm-10">
				   <input  name="spid"type="hidden" class="form-control round-input" placeholder="input Sponsor ID"  value="null"required> 
				 </div>
			   </div>
			   <div class="form-group">
				
				 <div class="col-sm-10">
				   <input name="spname" type="text" class="form-control round-input" placeholder="input Sponsor Name" required>
				 </div>
			   </div>
			   <div class="form-group">
			
				 <div class="col-sm-10">
				   <input name="sptid" type="text" class="form-control round-input" placeholder="input Driver Team ID" required>
				 </div>
			   </div>
			   <div class="form-group">
				
				 <div class="col-sm-10">
				   <input name="spemail" type="email" class="form-control round-input" placeholder="input Driver Email" required>
				 </div>
			   </div>
			   <div class="form-group">
				
				 <div class="col-sm-10">
				   <input name="sppass" type="password" class="form-control round-input" placeholder="input Password" required>
				 </div>
			   </div>
